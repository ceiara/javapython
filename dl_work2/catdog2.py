...
model = tf.keras.load_model('best=catdog=cnn-model.h5')

paths = ['cats_and_dogs_filtered/cats_and_dogs_filtered\\validation\\dogs\\dog.2000.jpg',

        'cats_and_dogs_filtered/cats_and_dogs_filtered\\validation\\cats\\cat.2000.jpg']
for path in paths:
